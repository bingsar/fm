                ...
                <section className="container">
                    <div className={styles.container__wrap}>
                        <div className={styles.column}>
                                        ...
                                        <div className={styles.property__props}>
                                            <div className={styles.property__type_wrap}>
                                                ...
                                                <div className={styles.property__type}>
                                                    { productCategories.edges.map((category) => { if (category.node.parentDatabaseId === propertyTypeCategory) {return <div className={styles.ifCategory}>{ category.node.name }</div> }}) }
                                                </div>
                                            </div>
                            ...
                            { !matches ? <div className={styles.property__info}>
                                    {attributes?.edges?.map((price, index) => {
                                        return price.node.name === 'Price' &&
                                            <CurrentSlugPrice price={[price.node.options[0]]} currency={router.query.currency}
                                                              changedValue={handleValue} changedCurrency={handleCurrency}
                                                              key={index}/>
                                    })}
                                    ...
                                    <div className={styles.sqmPerM}>
                                        ...
                                        <div className={styles.sqmPerM__value}>
                                            {attributes.edges.map((sqm) => {
                                                if (sqm.node.name === 'sqm') {
                                                    return (value / sqm.node.options[0]).toFixed(0)
                                                }
                                            })} {currency}
                                        </div>
                                    </div>
                                    <div className={styles.floor}>
                                        ...
                                        <div className={styles.floor__value}>
                                            {attributes.edges.map((floor) => {
                                                if (floor.node.name === 'Floor / levels') {
                                                    return floor.node.options[0]
                                                }
                                            })}
                                        </div>
                                    </div>
